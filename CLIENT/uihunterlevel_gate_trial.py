# -*- coding: utf-8 -*-
# ============================================================
# HUNTER SYSTEM - SUPREMO/TRIAL STATUS WINDOW
# ============================================================
# Finestra principale per visualizzare:
# - Stato Supremo World Boss (evocazione, timer, info)
...
class TrialStatusWindow(ui.Window):
    ...
    def __BuildUI(self):
        ...
        self.subtitleText.SetText("Supremi & Rank Trial")
        ...
        # ===== SUPREMO SECTION (ex Gate) =====
        self.gateSectionTitle = ui.TextLine()
        self.gateSectionTitle.SetParent(self)
        self.gateSectionTitle.SetPosition(20, 65)
        self.gateSectionTitle.SetText("[ SUPREMO - WORLD BOSS ]")
        self.gateSectionTitle.SetPackedFontColor(0xFFFF0000)
        ...
        self.gateStatusText.SetText("Stato: Non selezionato")
        ...
        self.gateTimerLabel.SetText("Tempo per evocare:")
        ...
        self.gateTimerText.SetPosition(150, 130)
        ...
        self.gateProgressBar.SetColor(0xFFFF0000)  # Rosso per Supremo
    ...
    def UpdateGateStatus(self, gateId, gateName, remainingSeconds, colorCode):
        ...
        if gateId > 0 and remainingSeconds > 0:
            self.gateStatusText.SetText("Stato: EVOCAZIONE DISPONIBILE")
            self.gateStatusText.SetPackedFontColor(0xFF00FF00)
            self.gateNameText.SetText("Supremo: " + self.gateData["name"])
            ...
            self.gateStatusText.SetText("Stato: Nessuna selezione")
            self.gateStatusText.SetPackedFontColor(0xFF808080)
            self.gateNameText.SetText("")
            self.gateTimerText.SetText("--:--:--")
...
def OpenGateTrialWindow():
    """Apre la finestra Supremo/Trial"""
    wnd = GetTrialStatusWindow()
    wnd.Show()

def CloseGateTrialWindow():
    """Chiude la finestra Supremo/Trial"""
    wnd = GetTrialStatusWindow()
    wnd.Close()
