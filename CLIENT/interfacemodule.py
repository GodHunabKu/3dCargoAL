...
class Interface(object):
	...
	def HunterSupremoSpawn(self, supremoName, rank, summonerName):
		...
		if self.wndHunterLevel:
			try:
				import hunter_windows
				if hasattr(hunter_windows, 'g_notificationWnd') and hunter_windows.g_notificationWnd:
					hunter_windows.g_notificationWnd.ShowNotification(
						"world_boss",
						"SUPREMO EVOCATO! %s (%s-Rank) è apparso! Evocato da: %s" % (supremoName, rank, summonerName)
					)
			except:
				pass
		# Messaggio in chat
