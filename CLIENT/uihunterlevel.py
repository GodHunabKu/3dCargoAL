    ...
    def __LoadAchievements(self):
        ...
        for catKey, catName, catColor, catType in CATEGORIES:
            ...
            for a in uniqueShow[:5]:
                ...
                if pctWidth > 0:
                    self.__CBar(10, y, pctWidth, 36, catColor if not claimed else 0xFF444444)
                ...
                if unlocked and not claimed:
                    ...
                    self.__CButton(320, y + 6, "RISCUOTI", ui.__mem_func__(self.__OnClaim), a.get("id", 0))
                elif claimed:
                    self.__CText("[OK]", 350, y + 10, 0xFF00AA00)
                else:
                    # Mostra percentuale
                    self.__CText("%d%%" % int(pct), 355, y + 10, 0xFF666666)
