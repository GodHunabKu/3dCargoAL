<!-- PAGINA ACCOUNT - VERSIONE 2.0 OTTIMIZZATA CON PRG PATTERN -->
<div class="admin-page-v2">
    <?php
        $account_name = getAccountName($_SESSION['id']);

        // Gestione azioni POST con sistema email ottimizzato + PRG Pattern
        ...
        if(isset($_POST['storekeeper-code'])) {
            ...
            if($code != '' && $code != '000000') {
                ...
                $_SESSION['notification'] = ['type' => 'warning', 'title' => 'Attenzione!', 'message' => $lang['no-storekeeper']];
            }
        ...
        // Recupera notifica dalla sessione (PRG Pattern)
        $notification = null;
        if(isset($_SESSION['notification'])) {
            $notification = $_SESSION['notification'];
            unset($_SESSION['notification']); // Rimuovi dopo averla letta
        }
    ?>
