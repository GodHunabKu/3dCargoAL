...
# ==============================================================================
	...
	def __HunterSystemSpeak(self, msg):
		...
		if self.interface:
			...
			if "|" in msg:
				...
				dbg.TraceError("[DEBUG] HunterSystemSpeak: rankKey='%s' msg='%s'" % (rank_key, actual_msg[:50]))
	...
	def __HunterAwakening(self, playerName):
		"""Mostra effetto risveglio al Lv 5"""
		try:
			if self.interface:
				self.interface.HunterAwakening(playerName.replace("+", " "))
		except:
			pass
