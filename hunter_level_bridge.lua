quest hunter_level_bridge begin
    state start begin
        ...
        function hunter_speak(msg)
            ...
            -- Se rank_num non è settato, calcolalo dai punti del DB
        ...
        function hunter_speak_color(msg, color_code)
            ...
            syschat("[LUA-1] hunter_speak_color: color=" .. final_color)
        ...
        function get_streak_message(day_number)
            ...
            -- Se non c'è messaggio specifico, cerca il più vicino inferiore
        ...
        when login with pc.get_level() >= 5 begin
            ...
            -- Assegna missioni giornaliere (se non già assegnate oggi)
            ...
            -- Controlla se c'è un evento attivo ORA e notifica
        ...
        -- ============================================================
        -- CHECK RANK UP - Controlla se il giocatore è salito di grado
        -- ============================================================
        ...
        function check_overtake(pid, pname, col_name, added_val, label_nice)
            ...
            -- Salva nel DB così lo vedrà al prossimo update
            -- ============================================================
        ...
        function process_normal_kill()
            -- SAFETY: Se una quest è attiva, non caricarne un'altra
            if pc.getqf("hq_emerg_active") == 1 then
        ...
        when 16060.click or 16061.click or 16062.click or 16063.click or 16064.click or 16065.click or 16066.click begin
            ...
            -- =====================================================
            -- LOGICA WHAT-IF / CLASSICO (probabilità da DB)
            -- =====================================================
        ...
        function assign_daily_missions()
            ...
            -- Controlla se ha già missioni oggi
            ...
            -- Chiama la stored procedure per assegnare missioni (ordine: player_id, rank, name)
            ...
            timer("hq_missions_notify", 6)  -- Dopo altri messaggi di login
            return true
        end
        ...
        function update_mission_progress(mission_type, amount, target_vnum)
            ...
            -- Trova missioni attive di questo tipo (JOIN per ottenere mission_type)
            -- Controlla anche target_vnum: 0 = qualsiasi, altrimenti deve corrispondere
        ...
        function check_all_missions_complete()
            ...
            if c > 0 and d[1] then
                ...
                if total >= 3 and completed >= 3 then
                    -- Tutte complete! Bonus x0.5 (già hanno preso 1x, ora aggiungiamo 0.5x)
        ...
        -- Hook: Quando uccidi un mob
        function on_mob_kill(mob_vnum)
            -- Aggiorna missioni kill_mob
        ...
        -- Se openWindow è true, apre anche la finestra
        ...
        -- Controlla se c'è un evento attivo e notifica al login
